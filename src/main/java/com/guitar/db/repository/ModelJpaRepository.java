...
public interface ModelJpaRepository extends JpaRepository<Model, Long> , ModelJpaRepositoryCustom {
    ...
    List<Model> findByPriceGreaterThanEqualAndPriceLessThanEqualAndWoodTypeContaining(BigDecimal low , BigDecimal high, String woodType);
    ...
    List<Model> queryFindAllModelsByType(@Param("name") String name);
}
